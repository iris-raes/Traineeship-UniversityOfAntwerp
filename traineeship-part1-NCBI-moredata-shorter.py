...
print("3 ---> If you want to search for <Copy Number Variations with clinical interpretation in Human (dbVar)>\n")
...
if choiceofsearch == "10":
    ...
    gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "insertion"[Variant Type])':'results-insertion-dbVar.csv',
    gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "inversion"[Variant Type])':'results-inversion-dbVar.csv',
    gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "short tandem repeat"[Variant Type])':'results-STR-dbVar.csv',
    gene+'[All Fields] AND ("Homo sapiens"[Organism] NOT "copy number variation"[Variant Type] NOT "insertion"[Variant Type] NOT "short tandem repeat"[Variant Type])':'results-lesscommon-dbVar.csv'}
if choiceofsearch == "1":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "copy number variation"[Variant Type] AND "Pathogenic"[clinical_interpretation])':'results-CNV-dbVar.csv'}
if choiceofsearch == "2":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "copy number variation"[Variant Type] AND "not reported"[clinical_interpretation])':'results-CNV-noclinint-dbVar.csv'}
if choiceofsearch == "3":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "copy number variation"[Variant Type] NOT "not reported"[clinical_interpretation])':'results-CNV-clinint-dbVar.csv'}
if choiceofsearch == "4":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "insertion"[Variant Type])':'results-insertion-dbVar.csv'}
if choiceofsearch == "5":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "inversion"[Variant Type])':'results-inversion-dbVar.csv'}
if choiceofsearch == "6":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] AND "short tandem repeat"[Variant Type])':'results-STR-dbVar.csv'}
if choiceofsearch == "7":
    terms={gene+'[All Fields] AND ("Homo sapiens"[Organism] NOT "copy number variation"[Variant Type] NOT "insertion"[Variant Type] NOT "short tandem repeat"[Variant Type])':'results-lesscommon-dbVar.csv'}
