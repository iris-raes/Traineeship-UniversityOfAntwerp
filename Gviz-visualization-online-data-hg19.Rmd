...
if(any(names(TableObject) == 'interpretation')){
  levels(GrangesObject$interpretation) <- list("#FF0000"="['Pathogenic']", 
...
levels(GrangesObject$type) <- list("#DFC27D"="copy number gain",
                                "#80CDC1"="copy number loss",
                                "#BF812D"="//",
                                "#F46D43"="insertion",
                                "#F46D43"="ins",
                                "#D73027"="inversion",
                                "#4575B4"="short tandem repeat",
                                "#A6CEE3"="copy-neutral loss of heterozygosity",
                                "#B2DF8A"="interchromosomal translocation",
                                "#FB9A99"="tandem duplication",
                                "#FF7F00"="complex substitution",
                                "#E31A1C"="copy number variation",
                                "#8DA0CB"="novel sequence insertion",
                                "#9970AB"="single nucleotide variant",
                                "#9970AB"="snv",
                                "#1B7837"="delins",
                                "#01665E"="deletion",
                                "#01665E"="del",
                                "#8C510A"="duplication",
                                "#CAB2D6"="alu insertion",
                                "#FFD92F"="sva insertion")
...
grtrack1 <- GeneRegionTrack(GeneModel, genome = "hg19", chromosome = chr1, 
                            ...
                            col.border.title = "black", col = NULL,
                            cex.title = 1.1, showId = TRUE, cex.group = 0.9, fill = "#DCDCDC")
gtrack1 <- GenomeAxisTrack(background.panel = "#FFFEDB",
                           ...
                           col.range = "black", col = "black", lwd = 1)
atrack1 <- AnnotationTrack(GrangesObject,
                           name = typeofvariant,
                           background.title = "dark gray",
                           background.panel = "#FFFEDB",
                           ...
                           fill = types, fontcolor.item = clinint, col = NULL)
```
