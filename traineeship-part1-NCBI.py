...
print("2 ---> If you want to search for <Insertions in Human (dbVar)>\n")
print("3 ---> If you want to search for <Inversions in Human (dbVar)>\n")
print("4 ---> If you want to search for <Short Tandem Repeats in Human (dbVar)>\n")
print("5 ---> If you want to search for <ClinVar variants>\n")
print("6 ---> If you want to search for 1, 2, 3, 4, 5\n")
...
if choiceofsearch == "1" or choiceofsearch == "6":
    ##### dbVar search
    ### Setting up query
...
if choiceofsearch == "2" or choiceofsearch == "6":
    ### Insertion in human
    insertion = []
...
if choiceofsearch == "3" or choiceofsearch == "6":
    ### Inversion in human
    inversion = []
...
if choiceofsearch == "4" or choiceofsearch == "6":
...
if choiceofsearch == "5" or choiceofsearch == "6":
    ##### ClinVar search
    ### Setting up query 
    ClinVar = []
